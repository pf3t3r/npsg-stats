...
tmp = 5:5:350;
for i=1:length(tmp)
    [n1(i),l1(i),sn1(i,:),sl1(i,:),g1(i),w1(i),pg1(i,:),pw1(i,:)] = testKurtosisBiasHelper(tmp(i),runs,false,N,L,G,W);
    [mn1(i),ml1(i),ssn1(i,:),ssl1(i,:),g2(i),w2(i),pg2(i,:),pw2(i,:)] = testSkewnessBiasHelper(tmp(i),runs,false,N,L,G,W);
end
