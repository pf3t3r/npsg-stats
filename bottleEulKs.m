...
ax11 = figure;
plotKs(dParc5,ksParc5,obsParc5,0,40,true);
...
ax12 = figure;
plotKs(dParc10,ksParc10,obsParc10,0.5,20.5,true);
...
ax13 = figure;
plotKs(dNit5,ksNit5,obsNit5,0,40,true);
...
ax14 = figure;
plotKs(dNit10,ksNit10,obsNit10,0.5,20.5,true);
...
ax15 = figure;
plotKs(dPho5,ksPho5,obsPho5,0,40,true);
...
ax17 = figure;
plotKs(dHet5,ksHet5,obsHet5,0,40,true);
...
ax18 = figure;
plotKs(dHet10,ksHet10,obsHet10,0.5,20.5,true);
...
ax19 = figure;
plotKs(dPro5,ksPro5,obsPro5,0,40,true);
...
ax20 = figure;
plotKs(dPro10,ksPro10,obsPro10,0.5,20.5,true);
...
ax21 = figure;
plotKs(dSyn5,ksSyn5,obsSyn5,0,40,true);
...
ax22 = figure;
plotKs(dSyn10,ksSyn10,obsSyn10,0.5,20.5,true);
...
ax23 = figure;
plotKs(dPic5,ksPic5,obsPic5,0,40,true);
...
ax24 = figure;
plotKs(dPic10,ksPic10,obsPic10,0.5,20.5,true);
