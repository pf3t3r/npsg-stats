...
tN = length(bottlePressure);

% Could functionalise the following
% Remove bottles taken at pressures below 2.5 db (within ~2.5 m of surface)

% chla - basic method
[pBin5,pBin10,chl_Out,n5,n10] = funshit(bottlePressure,bottleChl,botid);
bottleChl = chl_Out;
...
% 5 dbar
ksEb5 = nan(5,40); obsPerLevel_E5 = nan(40,1); 
...
% 10 dbar
ksEb10 = nan(5,20); obsPerLevel_E10 = nan(20,1);
...
%% figure this KS shit -> nope, moved
% 
