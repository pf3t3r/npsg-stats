...
[ks5, obs5, d5,sk5] = ksOfBinnedCon(chl_Out,pBin5,5);                    % 5 dbar / Chlorophyll a (Regular Method)
[ks10, obs10, d10,sk10] = ksOfBinnedCon(chl_Out,pBin10,10);               % 10 dbar / Chlorophyll a (Regular Method)
[ksHp5, obsHp5, dHp5, skHp5] = ksOfBinnedCon(chlOut_hplc,pb5_hplc,5);       % 5 dbar / HPLC Chlorophyll a
[ksHp10, obsHp10, dHp10,skHp10] = ksOfBinnedCon(chlOut_hplc,pb10_hplc,10);  % 10 dbar / HPLC Chlorophyll a

[ksAtp5, obsAtp5, dAtp5, skAtp5] = ksOfBinnedCon(atpOut,pb5_atp,5);          % 5 dbar / ATP
[ksAtp10, obsAtp10, dAtp10, skAtp10] = ksOfBinnedCon(atpOut,pb10_atp,10);     % 10 dbar / ATP

[ksCmo5, obsCmo5, dCmo5, skCmo5] = ksOfBinnedCon(cmoOut,pb5_cmo,5);          % 5 dbar / HPLC Monovinyl Chlorophyll a
[ksCmo10, obsCmo10, dCmo10, skCmo10] = ksOfBinnedCon(cmoOut,pb10_cmo,10);     % 10 dbar / HPLC Monovinyl Chlorophyll a

[ksCdi5, obsCdi5, dCdi5, skCdi5] = ksOfBinnedCon(cdiOut,pb5_cdi,5);          % 5 dbar / HPLC Divinyl Chlorophyll a
[ksCdi10, obsCdi10, dCdi10, skCdi10] = ksOfBinnedCon(cdiOut,pb10_cdi,10);     % 10 dbar / HPLC Divinyl Chlorophyll a

[ksParc5, obsParc5, dParc5, skParc5] = ksOfBinnedCon(parcOut,pb5_parc,5);     % 5 dbar / Particulate Carbon
[ksParc10, obsParc10, dParc10, skParc10] = ksOfBinnedCon(parcOut,pb10_parc,10);% 10 dbar / Particulate Carbon

[ksNit5, obsNit5, dNit5, skNit5] = ksOfBinnedCon(nitOut,pb5_nit,5);          % 5 dbar / Particulate Nitrogen
[ksNit10, obsNit10, dNit10, skNit10] = ksOfBinnedCon(nitOut,pb10_nit,10);     % 10 dbar / Particulate Nitrogen

[ksPho5, obsPho5, dPho5, skPho5] = ksOfBinnedCon(phoOut,pb5_pho,5);          % 5 dbar / Particulate Phosphorus
[ksPho10, obsPho10, dPho10, skPho10] = ksOfBinnedCon(phoOut,pb10_pho,10);     % 10 dbar / Particulate Phosphorus

[ksPho5_11, obsPho5_11, dPho5_11, skPho5_11] = ksOfBinnedCon(phoOut11,pb5_pho11,5,75);          % 5 dbar / Particulate Phosphorus 11-21
[ksPho10_11, obsPho10_11, dPho10_11, skPho10_11] = ksOfBinnedCon(phoOut11,pb10_pho11,10,75);     % 10 dbar / Particulate Phosphorus 11-21

[ksHet5, obsHet5, dHet5, skHet5] = ksOfBinnedCon(hetOut,pb5_het,5);          % 5 dbar / Heterotrophic Bacteria
[ksHet10, obsHet10, dHet10, skHet10] = ksOfBinnedCon(hetOut,pb10_het,10);     % 10 dbar / Heterotrophic Bacteria

[ksPro5, obsPro5, dPro5, skPro5] = ksOfBinnedCon(proOut,pb5_pro,5);          % 5 dbar / Prochlorococcus
[ksPro10, obsPro10, dPro10, skPro10] = ksOfBinnedCon(proOut,pb10_pro,10);     % 10 dbar / Prochlorococcus

[ksSyn5, obsSyn5, dSyn5, skSyn5] = ksOfBinnedCon(synOut,pb5_syn,5);          % 5 dbar / Synechococcus
[ksSyn10, obsSyn10, dSyn10, skSyn10] = ksOfBinnedCon(synOut,pb10_syn,10);     % 10 dbar / Synechococcus

[ksPic5, obsPic5, dPic5, skPic5] = ksOfBinnedCon(picOut,pb5_pic,5);          % 5 dbar / Pico-Eukaryotes
[ksPic10, obsPic10, dPic10, skPic10] = ksOfBinnedCon(picOut,pb10_pic,10);     % 10 dbar / Pico-Eukaryotes

%% Chlorophyll a (regular method): Eulerian 5 dbar

ax1 = figure;
plotKs(d5,ks5,obs5,sk5,0,40,true);
...
ax2 = figure;
plotKs(dHp5,ksHp5,obsHp5,skHp5,0,40,true);
...
ax3 = figure;
plotKs(d10,ks10,obs10,sk10,0.5,20.5,true);
...
ax4 = figure;
plotKs(dHp10,ksHp10,obsHp10,skHp10,0.5,20.5,true);
...
ax5 = figure;
plotKs(dAtp5,ksAtp5,obsAtp5,skAtp5,0,40,true);
...
ax6 = figure;
plotKs(dAtp10,ksAtp10,obsAtp10,skAtp10,0.5,20.5,true);
...
ax7 = figure;
plotKs(dCmo5,ksCmo5,obsCmo5,skCmo5,0,40,true);
...
ax8 = figure;
plotKs(dCmo10,ksCmo10,obsCmo10,skCmo10,0.5,20.5,true);
...
ax9 = figure;
plotKs(dCdi5,ksCdi5,obsCdi5,skCdi5,0,40,true);
...
ax10 = figure;
plotKs(dCdi10,ksCdi10,obsCdi10,skCdi10,0.5,20.5,true);
...
ax11 = figure;
plotKs(dParc5,ksParc5,obsParc5,skParc5,0,40,true);
...
ax12 = figure;
plotKs(dParc10,ksParc10,obsParc10,skParc10,0.5,20.5,true);
...
ax13 = figure;
plotKs(dNit5,ksNit5,obsNit5,skNit5,0,40,true);
...
ax14 = figure;
plotKs(dNit10,ksNit10,obsNit10,skNit10,0.5,20.5,true);
...
ax16 = figure;
plotKs(dPho10,ksPho10,obsPho10,skPho10,0.5,20.5,true);
sgtitle('Particulate Phosphorus: Eulerian Bottle, 10 dbar bin');
exportgraphics(ax16,'figures/ks_PhoEulerian10db.png'); clear ax16;

ax16a = figure;
plotKs(dPho10_11,ksPho10_11,obsPho10_11,skPho10_11,0.5,20.5,true,75);
...
ax17 = figure;
plotKs(dHet5,ksHet5,obsHet5,skHet5,0,40,true);
...
ax18 = figure;
plotKs(dHet10,ksHet10,obsHet10,skHet10,0.5,20.5,true);
...
ax19 = figure;
plotKs(dPro5,ksPro5,obsPro5,skPro5,0,40,true);
...
ax20 = figure;
plotKs(dPro10,ksPro10,obsPro10,skPro10,0.5,20.5,true);
...
ax21 = figure;
plotKs(dSyn5,ksSyn5,obsSyn5,skSyn5,0,40,true);
...
ax22 = figure;
plotKs(dSyn10,ksSyn10,obsSyn10,skSyn10,0.5,20.5,true);
...
ax23 = figure;
plotKs(dPic5,ksPic5,obsPic5,skPic5,0,40,true);
...
ax24 = figure;
plotKs(dPic10,ksPic10,obsPic10,skPic10,0.5,20.5,true);
